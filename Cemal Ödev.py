...
rms = sqrt(mean_squared_error(justdoit(test.VALUE), y_hat.naive))
print("RMSE: ",rms)
...
rms = sqrt(mean_squared_error(justdoit(test.VALUE), y_hat_avg.avg_forecast))
print("RMSE: ",rms)
...
rms = sqrt(mean_squared_error(justdoit(test.VALUE), y_hat_avg.moving_avg_forecast))
print("RMSE: ",rms)
...
rms = sqrt(mean_squared_error(justdoit(test.VALUE), y_hat_avg.SES))
print("RMSE: ",rms)

# Holt
print("Holt")
sm.tsa.seasonal_decompose(train.VALUE).plot()
result = sm.tsa.stattools.adfuller(justdoit(test.VALUE))
# plt.show()
...
rms = sqrt(mean_squared_error(justdoit(test.VALUE), y_hat_avg.Holt_linear))
print("RMSE: ",rms)
...
rms = sqrt(mean_squared_error(justdoit(test.VALUE), y_hat_avg.Holt_Winter))
print("RMSE: ",rms)
